...
ARGUMENTS = [
    ...
    # THESIS ADDITION: headless toggle. Default 'false' preserves the
    # original GUI behaviour exactly.
...
def generate_launch_description():
    ...
    # Gazebo harmonic
    # THESIS MODIFICATION: gz_args built conditionally on `headless`.
    gz_args_gui = [
        LaunchConfiguration('world'), '.sdf',
        ' -r', ' -v 4',
        ' --gui-config ',
        PathJoinSubstitution([
            pkg_turtlebot4_gz_bringup, 'gui',
    ...
    gazebo_gui = IncludeLaunchDescription(
        ...
        launch_arguments=[('gz_args', gz_args_gui)],
